...
<body>
  ...
  <div class="container">
    ...
    <div id="subbanner">
      ...
      <div id="photosSlider" class="swipe">
        <div class="swipe-wrap">
          ...
          <div class="slide">
            <img src="img/01.jpg" alt="The Exterior at Tortuga Beach Club Resort in Sanibel Island, Florida" />
          </div>
          
          <div class="slide">
            <img src="img/02.jpg" alt="The Living Area Tortuga Beach Club Resort in Sanibel Island, Florida" />
          </div>
          
          <div class="slide">
            <img src="img/03.jpg" alt="The Living Area at Tortuga Beach Club Resort in Sanibel Island, Florida" />
          </div>
          
          <div class="slide">
            <img src="img/04.jpg" alt="The Patio at Tortuga Beach Club Resort in Sanibel Island, Florida" />
          </div>
          
          <div class="slide">
            <img src="img/05.jpg" alt="The Jacuzzi at Tortuga Beach Club Resort in Sanibel Island, Florida" />
          </div>
    ...
    <div id="subtitle">
      ...
      <div class="banner-caption resort-title">
        <h1>Tortuga Beach Club Resort</h1>
      </div>
...
島のきらめく海と白浜が広がっています。プールサイドのガゼボ、プライベート・クラブハウスなど、優れた設備が整っており、楽園のバケーションをより一層引き立ててくれることでしょう。デューンズ・ゴルフ&amp;テニスクラブでは、グリーンフィーの免除をはじめ、さまざまな優待が用意されています。ショッピング街やレストランにも近く、大変便利なロケーションです。この地域ならではのビストロやカフェで、世界各国のシェフ達が影響をもたらしたとされる独創的な料理をご堪能ください。</p>
        ...
        <div class="col-sm-4 aside">
          ...
          <h3>Overview</h3>
          <address>959 E Gulf Dr, Sanibel Island, FL 33957</address>
          <p>Following serene walkways bordered by colorful tropical landscaping, vacationers at Tortuga Beach Club Resort are just a stroll away from Sanibel Island's magnificent white-sand beaches. Guests enjoy a poolside gazebo, a private clubhouse and superb resort amenities, as well as complimentary greens fees and other select offerings at The Dunes Golf and Tennis Club. Marvelous shopping and dining are just minutes away, including delightfully inventive cuisine at the area's signature bistros and cafes. Chefs from around the world have brought their creative influence to Sanibel and Captiva, providing an ideal complement to every vacation in this island paradise.</p>
          
          <br />
          
          <h3>Accommodations</h3>
          <ul>
            <li>Spacious 2-bedroom townhouses with screened balconies</li>
            <li>Each townhouse features fully equipped kitchen, washerand dryer</li>
          </ul>
          ...
          <ul>
            ...
            <li>Family recreation activities</li>
          </ul>
          
          <br />
          
          <h3>Additional Info</h3>
          <p>Check In: 3 p.m.<br />Check Out: 10 a.m.<br />Phone: 239-472-0400</p>
