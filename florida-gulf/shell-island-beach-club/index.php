...
<head>
  ...
  <title>Shell Island Beach Club Resort in Sanibel Island, Florida</title>
  <?php addStyles(); ?>
</head>
<body>
    ...
    <div id="subcontent" class="content">
      ...
      <div class="row">
        ...
        <div class="col-sm-8 main-column">
          ...
          <address>255 Periwinkle Way, Sanibel Island, FL 33957</address>
          <p>サニベル島南端に位置するシェルアイランド・ビーチ・クラブ・リゾートから、コバルトブルー 
に輝くのどかなメキシコ湾が見渡せます。歴史的なサニベル灯台の近くにあり、陽光まぶしいビーチで貝殻集めやウォータースポーツにぴったりの環境です。さまざまなレクリエーション、ショッピング、レストラン、エンターテイメントへのアクセスも充実しています。</p>
		  <p>サイクリングコース、自然を楽しむ散歩コース、スノーケリング、スキューバダイビング、沖釣りなど、サニベル島ならではの思い出に残るバケーションを是非お楽しみください。</p>
          ...
          <h3>リゾート設備</h3>
          <ul>
            <li>2つの温水プール（うち1つはジャグジーとサウナ付き）</li>
            <li>テニスコート</li>
            <li>加盟リゾート</li>
            <li>34年間の実績</li>
            <li>予約制限あり</li>
        ...
        <div class="col-sm-4 aside">
          <h3>追加情報</h3>
          <p>チェックイン: 3 p.m.<br />チェックアウト: 10 p.m.<br />電話番号: 239-472-4497</p>
