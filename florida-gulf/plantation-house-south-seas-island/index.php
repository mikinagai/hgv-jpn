...
<body>
  ...
  <div class="container">
    ...
    <div id="subbanner">
      ...
      <div id="photosSlider" class="swipe">
        <div class="swipe-wrap">
          ...
          <div class="slide">
            <img src="img/01.jpg" alt="The Exterior at Plantation House at South Seas Island Resort in Captiva Island, Florida" />
          </div>
          
          <div class="slide">
            <img src="img/02.jpg" alt="The Exterior at Plantation House at South Seas Island Resort in Captiva Island, Florida" />
          </div>
          
          <div class="slide">
            <img src="img/03.jpg" alt="The Pool at Plantation House at South Seas Island Resort in Captiva Island, Florida" />
          </div>
          
          <div class="slide">
            <img src="img/04.jpg" alt="The Pool at Plantation House at South Seas Island Resort in Captiva Island, Florida" />
          </div>
      ...
      <div class="banner-caption resort-title">
        <h1>プランテーション・ハウス・アット・サウスシーズ・アイランド・リゾート</h1>
      </div>
    ...
    <div id="subtitle">
      ...
      <div class="banner-caption resort-title">
        <h1>Plantation House at South Seas Island Resort</h1>
      </div>
    ...
    <div id="subcontent" class="content">
      ...
      <div class="row">
        ...
        <div class="col-sm-8 main-column">
          ...
          <p>キャプティバ島の先端にある優雅なプランテーション・ハウス。伝統的なブリキ屋根や天然木材をふんだんに使った建物は、美しく閑静な楽園の景色に溶け込んでいます。サウスシーズ・アイランド・リゾートの恵まれた環境の中に位置し、エキサイティングなレクリエーション施設もすぐ近くにあります。ゆっくり寛ぎたい方にも、アドベンチャーを楽しみたい方にも最適です。優しい潮風と美しい海辺の景色に囲まれた、昔ながらの島の魅力を、たっぷりと気ままにお楽しみください。</p>
          ...
          <h3>追加情報</h3>
          <p>チェックイン: 3 p.m.<br />チェックアウト: 10 p.m.<br />電話番号: 239-472-5111</p>
        ...
        <div class="col-sm-4 aside">
          ...
          <h3>Overview</h3>
          <address>5400 Plantation Rd, Captiva Island, FL 33924</address>
          <p>Located at the tranquil tip of Captiva Island, Plantation House blends perfectly with the surrounding beauty of this secluded subtropical paradise. With architecture that incorporates detailed natural wood and signature tin roofs, the resort features elegantly appointed accommodations and a prime location for both relaxation and adventure. Superbly positioned within the renowned South Seas Island Resort, this peaceful getaway provides immediate access to the resort's vibrant array of exciting amenities and recreation options, while delivering a timeless island experience replete with gentle ocean breezes, stunning seaside views and the freedom to set your own pace.</p>
