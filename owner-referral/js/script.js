...
submitButton.click(function(e){
  var officeCode;
  var officeDesc;
  var switchHelp = parseInt(sitecodeField.val());
  switch(switchHelp){
    case 9589:
      officeCode = 46;
      officeDesc = "Parc Soleil";
      break;
    case 9590:
      officeCode = 39;
      officeDesc = "HGVClub on the Las Vegas Strip";
      break;
    case 9591:
      officeCode = 93;
      officeDesc = "MYB Palms";
      break;
    case 9592:
      officeCode = 30;
      officeDesc = "Sunrise Lodge";
      break;
    case 9593:
      officeCode = 555;
      officeDesc = "HHV Line Sales";
      break;
    case 9594:
      officeCode = 567;
      officeDesc = "Waikoloa Kings Land";
      break;
    case 9595:
      officeCode = 220;
      officeDesc = "Grand Pacific Palisades";
      break;
    default:
      break;
  }
  for(var x=0; x<referralsArray.length; x++){
    ...
    $.ajax({
      ...
      data: {
        ...
        "00N50000002bDfV": officeCode,
        "00N50000002bDfU": officeDesc
      }
    });
  }
  anyslider.next();
